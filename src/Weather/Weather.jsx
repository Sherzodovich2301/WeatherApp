  ...
  return (
    <div className="bg-Sunset bg-center overflow-hidden bg-no-repeat bg w-full bg-cover h-[100vh]">
      <div className="hello flex flex-col xl:flex-row justify-between items-center gap-10">
        <div className="xl:mb-0 turn:mb-[40px] xl:ml-[40px] md:w-[350px] turn:w-[200px] w-[400px] h-[765px] flex flex-row xl:flex-col xl:mt-[0px] turn:mt-[-500px] items-end xl:gap-0 turn:gap-[230px] turn:ml-[0px] sm:ml-[-350px]">
